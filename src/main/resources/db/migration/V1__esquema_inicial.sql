...
CREATE TABLE products (
  ...
  category ENUM(
      'PERIFERICOS', 'AUDIO', 'MOVEIS', 'INFORMATICA', 'ELETRONICOS', 'MODA',
      'ELETRODOMESTICOS', 'LIVROS', 'ACESSORIOS', 'GAMES', 'ESPORTES', 'AUTOMOTIVO',
      'BRINQUEDOS', 'BELEZA', 'SAUDE', 'PETSHOP', 'FERRAMENTAS', 'PAPELARIA', 'ALIMENTOS'
      ) NOT NULL,
